...
#' @param test upper tail, lower tail, or two--both--tails
#'
#' @return plot, and list of tcalc, pvalue, sample size, data points, type of test, and conf. interval
#' @export
#'
#' @examples
#'
#' bootpval(c(4, 5, 2, 3, 4, 5, 1), conf.level = 0.95, mu0 = 1)
